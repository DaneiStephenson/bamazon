...
// This is an empty array that will be used to store the items from mysql database
// It's needed because I want to be able to react with that database on a global level
// on my javascript application.
var items = [];

// This is the constructor function for my items in which will store the necessary information
// needed to interact with the data. Each parameter will be passed in once I grab the information
...
// This is the information needed to connect to the mysql database
var connection = mysql.createConnection({
  host: "localhost",
  port: 3306,
  user: "root", // Your username
  password: "", // Your password; my password is root, you may have to change it
  database: "bamazon" // Database in mySQL workbench; make sure it matches yours
})
